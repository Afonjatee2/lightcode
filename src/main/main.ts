  ...
  void app
    ...
    .then(async () => {
      ...
      const supervisorClient = new SupervisorClient({
        ...
        onEvent: (event) => {
          // Consultation create_thread requests are consumed here (DB upsert,
        ...
        // A fresh supervisor process has an empty consultation child registry;
        // push the persisted child rows back so consultation reconciliation can
        // keep resolving children created before the restart.
        onStarted: () => {
