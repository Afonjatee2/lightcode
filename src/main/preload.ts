...
const bridge: LightcodeBridge = {
  ...
  generatePrSummary: (payload) => ipcRenderer.invoke(CHANNELS.generatePrSummary, payload),
  extractContext: (payload) => ipcRenderer.invoke(CHANNELS.extractContext, payload),
  cancelExtractContext: (payload) => ipcRenderer.invoke(CHANNELS.cancelExtractContext, payload),
  readTerminalScrollback: (payload) => ipcRenderer.invoke(CHANNELS.readTerminalScrollback, payload),
  saveHandoffContext: (payload) => ipcRenderer.invoke(CHANNELS.saveHandoffContext, payload),
  ...
  gitSwitchBranch: (payload) => ipcRenderer.invoke(CHANNELS.gitSwitchBranch, payload),
  ...
  listProjectTree: (payload) => ipcRenderer.invoke(CHANNELS.listProjectTree, payload),
  searchProjectTree: (payload) => ipcRenderer.invoke(CHANNELS.searchProjectTree, payload),
  readProjectFile: (payload) => ipcRenderer.invoke(CHANNELS.readProjectFile, payload),
  writeProjectFile: (payload) => ipcRenderer.invoke(CHANNELS.writeProjectFile, payload),
  createProjectEntry: (payload) => ipcRenderer.invoke(CHANNELS.createProjectEntry, payload),
  renameProjectEntry: (payload) => ipcRenderer.invoke(CHANNELS.renameProjectEntry, payload),
  moveProjectEntry: (payload) => ipcRenderer.invoke(CHANNELS.moveProjectEntry, payload),
  deleteProjectEntry: (payload) => ipcRenderer.invoke(CHANNELS.deleteProjectEntry, payload),
  revealProjectEntry: (payload) => ipcRenderer.invoke(CHANNELS.revealProjectEntry, payload),
  ...
  lspStart: (payload) => ipcRenderer.invoke(CHANNELS.lspStart, payload),
  lspStop: (payload) => ipcRenderer.invoke(CHANNELS.lspStop, payload),
  lspSendMessage: (payload) => ipcRenderer.invoke(CHANNELS.lspMessage, payload),
