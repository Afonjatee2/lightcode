...
describe("SkillsManager", () => {
    ...
    useSkillsMock.mockReturnValue({
      scan: scan([
        ...
        skill({
          ...
          providerId: "poracode",
          providerLabel: "Tee's Cockpit only",
          providerGroupId: "poracode",
          providerGroupLabel: "Tee's Cockpit",
        ...
        skill({
          ...
          providerLabel: "Tee's Cockpit built-ins",
          providerGroupId: "poracode",
          providerGroupLabel: "Tee's Cockpit",
          providerGroupOrder: -1,
          origin: "built-in",
  ...
  it("groups managed, external, and provider-owned skills", () => {
    ...
    expect(screen.getByText("Tee's Cockpit only")).toBeInTheDocument();
    ...
    const poracodeSection = screen
      .getByRole("heading", { name: "Tee's Cockpit" })
      .closest("section")!;
    ...
    expect(screen.queryByText("Tee's Cockpit built-ins")).not.toBeInTheDocument();
