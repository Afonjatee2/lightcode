...
export const SETTINGS_SEARCH_INDEX: readonly SettingsSearchEntry[] = [
  // General
  {
    ...
    title: msg`Language`,
    description: msg`Choose the display language for Tee's Cockpit's interface.`,
  ...
  },
  {
    ...
    description: msg`When you close the window, keep Tee's Cockpit running in the system tray. Disable to quit on close.`,
  ...
  },
  {
    ...
    description: msg`Launch Tee's Cockpit automatically when you sign in to Windows.`,
  ...
  },
  {
    ...
    description: msg`Keep Tee's Cockpit in the system tray when it launches at startup.`,
  ...
  },
  {
    ...
    title: msg`Theme`,
    description: msg`Popular editor themes adapted to Tee's Cockpit. Each follows the light or dark mode above.`,
  ...
  // MCP Servers
  {
    ...
    description: msg`Manage the MCP server configurations Tee's Cockpit adds when starting supported agents. Workspace servers can be configured in each project's settings.`,
    keywords:
  ...
  // Browser
  {
    ...
    description: msg`Choose whether links from Tee's Cockpit and browser popups stay in Tee's Cockpit or open externally.`,
  ...
  },
  {
    ...
    description: msg`When links open in a Tee's Cockpit browser tab, choose where the browser is revealed.`,
