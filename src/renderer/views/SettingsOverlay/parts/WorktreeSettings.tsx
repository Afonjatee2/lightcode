...
export function WorktreeSettings() {
  ...
  return (
    <SettingsPage
      title={t`Worktrees`}
      description={t`Where Tee's Cockpit creates git worktrees for new branches. Changes apply to worktrees created from now on; existing worktrees stay where they are.`}
    >
      <SettingRow
