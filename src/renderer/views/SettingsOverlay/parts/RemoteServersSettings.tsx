...
export function RemoteServersSettings() {
  ...
  return (
    <SettingsPage
      ...
      description={t`Connect directly, through a relay, or over SSH. Every transport uses the same Tee's Cockpit remote protocol, projects, threads, and agent runtimes.`}
      ...
      {adding === "direct" ? (
        ...
        <div className="flex gap-2">
          <Button variant="tertiary" size="sm" onPress={() => setAdding("direct")}>
            ...
            <Trans>Pair with Tee's Cockpit</Trans>
          </Button>
