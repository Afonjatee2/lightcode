...
export function createSupervisorIpcHandlers(runtime: SupervisorRuntime): SupervisorIpcHandlerMap {
  return defineSupervisorIpcHandlers({
    ...
    authenticateAcpRegistryAgent: (payload) => runtime.authenticateAcpRegistryAgent(payload),
    logoutAcpRegistryAgent: (payload) => runtime.logoutAcpRegistryAgent(payload),
