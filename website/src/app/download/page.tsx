  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-black text-white">
      ...
      <main className="relative z-10 max-w-3xl mx-auto px-8 py-12">
        ...
        >
          <h1 className="text-3xl md:text-4xl font-bold tracking-tight mb-3">Download Lightcode</h1>
            ...
            >
              ...
              <div className="grid gap-3">
                {platform.variants.map((variant) => (
                  <a
                    key={variant.slug}
                    href={`/api/download/${variant.slug}`}
        ...
        >
          <p className="text-sm text-gray-600">
            ...
            <a
              href="https://github.com/SDSLeon/lightcode/releases/latest"
              target="_blank"
              rel="noreferrer"
